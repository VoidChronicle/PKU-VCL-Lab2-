...
namespace VCX::Labs::GeometryProcessing {
    ...
    public:
        ...
        bool IsContractable(HalfEdge const * edge) const {
            ...
            /*if (edge->From() == 1544) {
                printf("iscontarctable:falg1:1544\n");
                printf("%d", edge->To());
                for (auto q_opposite_edge : Vertex(edge->To())->Ring()) {
                    printf("q %d->%d\n", q_opposite_edge->From(), q_opposite_edge->To());
                }
            }*/
            for (auto q_opposite_edge : Vertex(edge->To())->Ring()) {
                //if (edge->From() == 1544) printf("iscontarctable:falg5:1544\n");
                ...
                if (conflict_vertices.count(q_opposite_edge->To()) 
                    ...
                    //if (edge->From() == 1544) printf("iscontarctable:falg2:1544\n");
                    return false;
                }
                ...
                if (conflict_edges.count(IndexOf(q_opposite_edge->TwinEdge()))) {
                    //if (edge->From() == 1544) printf("iscontarctable:falg3:1544\n");
                    return false;
                }
            }
            //if (edge->From() == 1544) printf("iscontarctable:falg4:1544\n");
            // std::cout << 'T' << std::endl;
            return true;
        }
